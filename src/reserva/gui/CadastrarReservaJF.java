 ...
 * @author Anderson
 */
public class CadastrarReservaJF extends javax.swing.JFrame {
    ...
    private void btnReservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservaActionPerformed
        try {
            ...
            Logger.getLogger(CadastrarReservaJF.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarReservaJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarReservaJF().setVisible(true);
            }
        });
    }
    ...
    private boolean validarCampos() throws ParseException {
        String dataRetirada = dataRetiradaReserva.getText();
        String dataDevolucao = dataDevolReserva.getText();
        ReservaService rService = new ReservaService();
        Servico servico = new Servico();
        if(!rService.verificarDatas(dataRetirada, dataDevolucao)){
