...
public class EscolhaLocacaoPesquisaOuAddJF extends javax.swing.JFrame {
...
//    private boolean frameFilialOpen = false;
    public EscolhaLocacaoPesquisaOuAddJF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAddOuRemLocacao.setText("Adicionar ou remover locação");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscolhaLocacaoPesquisaOuAddJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscolhaLocacaoPesquisaOuAddJF().setVisible(true);
            }
        });
    }
